...
alarm[0] = 5;
zoomEnabled = false; // allow player manual zoom

cameraMode_ = "";
 jumpToTargetInstantly = false;


#region camera mode

function cameraMode(timeTotal_, startX_, startY_, targetX_, targetY_,   ){
...
// 85 : 48
 if (Aspect_Ratio_Width == 64 and Aspect_Ratio_Height == 48) { 
