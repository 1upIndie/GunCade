...
scr_ButtonResult_Create( "heavy 1", 0);
scr_ButtonResult_Create( "heavy 2", 1);
scr_ButtonResult_Create( "heavy 3", 2);
scr_ButtonResult_Create( "heavy 4", 3);
scr_ButtonResult_Create( "heavy 5", 4);
