...
array_OfficeProp[officeProp_I] = new createOffice_Prop(officeProp_I, "Flowers", 120, 0, 3, 0, spr_Office_Flowers, 741, 418 )
...
#region Kyle
			 ...
			 /////// Kyle	
			  case  "kyle default":		  
				   ...
				   sprTalk_        = spr_Dialog_Kyle_Talk_Blink; 	// talking, no blink	
				   break;
			  ...
			  case  "kyle angry":		  
				   sprIdleStatic   = spr_Dialog_Kyle_Angry_JustBlink;
				   sprIdle_        = spr_Dialog_Kyle_Angry_SingleImage; 
				   sprTalkStatic_  = spr_Dialog_Kyle_TalkNoBlink; 		  
				   sprTalk_        = spr_Dialog_Kyle_Talk_Blink; 		 break;
	
			  case  "kyle smiling":		  
				   sprIdleStatic   = spr_Dialog_Kyle_JustBlink;
				   sprIdle_        = spr_Dialog_Kyle_SingleImage; 
				   sprTalkStatic_  = spr_Dialog_Kyle_TalkNoBlink; 		  
				   sprTalk_        = spr_Dialog_Kyle_Talk_Blink; 		 break;
...
#region Shadow
			 ...
			 /////// Shadow					   
			  ...
			  case  "shadow angry":  
				   sprIdleStatic   = spr_Dialog_ShadowAngry_Idle;
				   sprIdle_        = spr_Dialog_ShadowAngry_Idle; 
				   sprTalkStatic_  = spr_Dialog_Shadow_TalkStatic; 		  
				   sprTalk_        = spr_Dialog_Shadow_Talk; 		  break;
				   
			  case  "shadow smiling":  
				   sprIdleStatic   = spr_Dialog_ShadowHappy_Idle;
				   sprIdle_        = spr_Dialog_ShadowHappy_Idle; 
				   sprTalkStatic_  = spr_Dialog_Shadow_TalkStatic; 		  
				   sprTalk_        = spr_Dialog_Shadow_Talk; 		  break;

			  case  "shadow grumpy":  
				   sprIdleStatic   = spr_Dialog_ShadowUnHappy_Idle;
				   sprIdle_        = spr_Dialog_ShadowUnHappy_Idle; 
				   sprTalkStatic_  = spr_Dialog_Shadow_TalkStatic; 		  
				   sprTalk_        = spr_Dialog_Shadow_Talk; 		  break;	

			  case  "shadow shocked":  
				   sprIdleStatic   = spr_Dialog_ShadowShocked_Idle;
				   sprIdle_        = spr_Dialog_ShadowShocked_Idle; 
				   sprTalkStatic_  = spr_Dialog_Shadow_TalkStatic; 		  
				   sprTalk_        = spr_Dialog_Shadow_Talk; 		  break;	
				   
			  case  "shadow dismissive":  
				   sprIdleStatic   = spr_Dialog_ShadowDismissive_Idle;
...
#region Granny	
			 ...
			 /////// Granny		
			  ...
			  case  "granny angry":		  
				   sprIdleStatic   = spr_Dialog_GrannyAngry_IdleStatic;
				   sprIdle_        = spr_Dialog_GrannyAngry_Idle; 
				   sprTalkStatic_  = spr_Dialog_GrannyAngry_TalkStatic; 		  
				   sprTalk_        = spr_Dialog_GrannyAngry_Talk; 		break;	

              case  "granny smiling":		  
				   sprIdleStatic   = spr_Dialog_GrannyHappy_IdleStatic;
				   sprIdle_        = spr_Dialog_GrannyHappy_Idle; 
				   sprTalkStatic_  = spr_Dialog_Granny_TalkStatic; 		  
				   sprTalk_        = spr_Dialog_Granny_Talk; 		break;	

			  case  "granny dismissive":		  
				   sprIdleStatic   = spr_Dialog_GrannyDismissive_IdleStatic;
				   sprIdle_        = spr_Dialog_GrannyDismissive_Idle; 
...
#region Weather
			 ...
			 /////// Weather	
			  case  "weather default":  
				   sprIdleStatic   = spr_Dialog_Weather_IdleStatic;
				   sprIdle_        = spr_Dialog_Weather_Idle; 
				   sprTalkStatic_  = spr_Dialog_Weather_TalkStatic; 		  
				   sprTalk_        = spr_Dialog_Weather_Talk; 		    break;	

			  case  "weather smiling":  
				   sprIdleStatic   = spr_Dialog_Weather_HappyStatic;
				   sprIdle_        = spr_Dialog_Weather_Happy; 
				   sprTalkStatic_  = spr_Dialog_Weather_TalkStatic; 		  
				   sprTalk_        = spr_Dialog_Weather_Talk; 		    break;	
...
#region shadow 52 -
     ...
     arrayCutscenes[day_I].setSprite(dialog_I,2, "shadow dismissive"  , "");		 
...
/////////////////////////////////////////////	 
	 // sale 101
	 dialog_I = 110;	 
     arrayCutscenes[day_I].setSprite(dialog_I,2, "shadow smiling"  , "");		 
 ...
 dialog_I = 0; // zeiger
  ...
  arrayCutscenes[day_I] = new Createcutscene(day_I , false); // first cutscene   
   ...
   #region  clown enter  150 to
     ...
     arrayCutscenes[day_I].setSprite(dialog_I,1, "clown default"  , ""); 
     arrayCutscenes[day_I].setText(dialog_I,  1, "clown", "Hey, I'm serious. I usually dump his stuff in the river, but now that you're open, I got a deal that is good for both of us.", snd_TextScroll_Default );		  	 
	 dialog_I++;
...
#region  day 5  5555555555555555
 ...
 #region monolog + clown
    ...
    // if accepted gift
     ...
     arrayCutscenes[day_I].setSprite(dialog_I,1, "clown default"  ,  "");	 
     arrayCutscenes[day_I].setText(dialog_I,  1, "playerT", "(So says a thieving clown.)", snd_TextScroll_Default );		 
	 dialog_I++;	 
    ...
    // if denied gift
     ...
     arrayCutscenes[day_I].setSprite(dialog_I,1, "clown default"  ,  "");	 
     arrayCutscenes[day_I].setText(dialog_I,  1, "playerT", " (I hope not.)", snd_TextScroll_Default );		 
	 dialog_I++;	 	 
	 
     arrayCutscenes[day_I].setSprite(dialog_I,1, "clown default"  ,  "");	 
     arrayCutscenes[day_I].setText(dialog_I,  1, "playerT", "(Ugghhhhh...)", snd_TextScroll_Default );		 
	 arrayCutscenes[day_I].dialogBlock_LoadIn[dialog_I] = obj_Dialog_SkipIndex_to_90; 	 	 
	 dialog_I++;		 
